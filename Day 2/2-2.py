test_input_string = """Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
Game 3: 8 green, 6 blue, 20 red; 5 blue, 4 red, 13 green; 5 green, 1 red
Game 4: 1 green, 3 red, 6 blue; 3 green, 6 red; 3 green, 15 blue, 14 red
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green"""
input_string = """Game 1: 7 blue, 4 red, 11 green; 2 red, 2 blue, 7 green; 2 red, 13 blue, 8 green; 18 blue, 7 green, 5 red
...
for game in games:
    ...
    for draw in draws:
        ...
        for cube in cubes:
            if "red" in cube:
                if red_cubes < int(get_num(cube)):
                    red_cubes = int(get_num(cube))
            if "blue" in cube:
                if blue_cubes < int(get_num(cube)):
                    blue_cubes = int(get_num(cube))
            if "green" in cube:
                if green_cubes < int(get_num(cube)):
                    green_cubes = int(get_num(cube))
    print("\nred =", red_cubes, "; green =", green_cubes, "; blue =", blue_cubes)
    games_power_sum += red_cubes*blue_cubes*green_cubes
