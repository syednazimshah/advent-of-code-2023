...
input_string = """..224.....487...................718.....................378............................................284........310......313..........311.
...
def is_symbol(string):
    if string in new_string:#== "*" or string == "&" or string == "#" or string == "!" or string == "@" or string == "$" or string == "%" or string == "^" or string == "=" or string == "+" or string == "-" or string == "/" or string == "_":
        return True
    else:
        return False
...
new_string = ''.join(["" if (char.isdigit() or char == ".") else char for i, char in enumerate(input_string)])
# print(new_string)
...
for i in range(len(lines)):
    ...
    for j in range(len(eachline)):
        ...
        if eachchar.isdigit():
            num+=eachchar
            if (j+1 < len(eachline) and is_symbol(eachline[j+1])) or (j-1 >= 0 and is_symbol(eachline[j-1])) or (i+1 < len(lines) and is_symbol(lines[i+1][j])) or (i-1 >= 0 and is_symbol(lines[i-1][j])):     
                # print("found valid", eachchar)
                isValid=True
            if (i+1 < len(lines) and j-1 >= 0 and is_symbol(lines[i+1][j-1])) or (i+1 < len(lines) and j+1 < len(eachline) and is_symbol(lines[i+1][j+1])) or (i-1 >=0 and j-1 >= 0 and is_symbol(lines[i-1][j-1])) or (i-1 >=0 and j+1 < len(eachline)and is_symbol(lines[i-1][j+1])):
                # print("found valid", eachchar)
                isValid=True
            if  j+1 == len(eachline) or (j+1 < len(eachline) and (not eachline[j+1].isdigit())):
                isComplete = True
            if isComplete:
                if isValid:
                    # print("Complete valid num is " , num)
                    list_of_valid_part_numbers.append(int(num))
                isValid = False
                isComplete=False
                num = ""

# print(list_of_valid_part_numbers)

print("sum is ", sum(list_of_valid_part_numbers))